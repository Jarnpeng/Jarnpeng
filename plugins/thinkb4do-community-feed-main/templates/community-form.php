...
$tb4c_form_name   = ( $tb4c_form_user && $tb4c_form_user->ID ) ? $tb4c_form_user->display_name : __( 'ผู้ใช้ Thinkb4do', 'thinkb4do-community' );
$tb4c_form_member = ( $tb4c_form_user && $tb4c_form_user->ID ) ? tb4cf_social_profile_url( $tb4c_form_user->ID ) : '';
?>
<form class="tb4c-form tb4c-social-form tb4c-popup-composer-form tb4c-v42111-smart-form" id="tb4cCommunityForm" enctype="multipart/form-data" data-tb4c-community-form data-tb4c-smart-composer-form data-tb4c-smart-composer-all-pages-form data-tb4c-stable-composer-form>
  ...
  <section class="tb4c-v42104-smart-author" aria-label="ข้อมูลผู้โพสต์และสถานะ Smart Composer">
    <?php if ( $tb4c_form_member ) : ?>
    <a class="tb4c-avatar tb4c-v42104-smart-avatar tb4c-member-link" href="<?php echo esc_url( $tb4c_form_member ); ?>" data-tb4c-member-link="<?php echo esc_attr( $tb4c_form_user->ID ); ?>" title="ดูหน้าสมาชิกของฉัน">
      <?php if ( $tb4c_form_avatar ) : ?>
        <img src="<?php echo esc_url( $tb4c_form_avatar ); ?>" alt="">
      <?php else : ?>
        <?php echo esc_html( tb4cf_get_initial( $tb4c_form_name ) ); ?>
      <?php endif; ?>
    </a>
    <?php else : ?>
    ...
    <div class="tb4c-v42104-smart-author-copy">
      <?php if ( $tb4c_form_member ) : ?><a class="tb4c-author-name-link tb4c-member-link" href="<?php echo esc_url( $tb4c_form_member ); ?>" data-tb4c-member-link="<?php echo esc_attr( $tb4c_form_user->ID ); ?>"><strong><?php echo esc_html( $tb4c_form_name ); ?></strong></a><?php else : ?><strong><?php echo esc_html( $tb4c_form_name ); ?></strong><?php endif; ?>
  ...
  <nav class="tb4c-v42104-smart-toolbar" aria-label="เครื่องมือ Smart Composer">
    <button type="button" class="tb4c-v42104-smart-tool is-active" data-tb4c-smart-panel-btn="meta" aria-expanded="true">
      <?php echo tb4cf_icon_markup( 'ph-hash', '#' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
      <span>Tag</span>
    </button>
    <label for="tb4c-post-media-file" class="tb4c-v42104-smart-tool" data-tb4c-smart-upload tabindex="0">
      <?php echo tb4cf_icon_markup( 'ph-upload-simple', '↑' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
      <span>ไฟล์</span>
    </label>
    ...
    <button type="button" class="tb4c-v42104-smart-tool" data-tb4c-smart-panel-btn="poll" aria-expanded="false">
      <?php echo tb4cf_icon_markup( 'ph-chart-bar', '▥' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
      <span>โพล</span>
    </button>
    <button type="button" class="tb4c-v42104-smart-tool" data-tb4c-smart-panel-btn="settings" aria-expanded="false">
      <?php echo tb4cf_icon_markup( 'ph-sliders-horizontal', '≡' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
      <span>ตั้งค่า</span>
    </button>
  </nav>
