(function () {
  ...
  function tb4cHasCommunitySurface42114() {
    ...
    return !!doc.querySelector('.tb4c-shell, #tb4c-community-app, .tb4c-post-card, .tb4c-comments-card, .tb4c-home-menu-feed, .tb4-home-feed-main, #tb4cCommunityForm, [data-tb4c-video-slot], [data-tb4c-community-surface]');
  }
  ...
  function buildPreviewDataFromHtml(commentHtml) {
    ...
    data = {
      ...
      author: getTextClean(author) || 'ผู้ใช้',
  ...
  function updateCommentPreview(rootEl, commentHtml, responseData) {
    ...
    strong.textContent = data.author || 'ผู้ใช้';
  ...
  if (doc.readyState === 'loading') doc.addEventListener('DOMContentLoaded', function () { initPopupComposerForceReady(); initComposerV490Guard(); initComposerOptInOnly(); initComposerInlineReturn(); initHorizontalRailButtons(); initReelExperience(); initVideoCovers(); /* v4.2.262: mini video disabled here, owned by community.js */ });
  else { initPopupComposerForceReady(); initComposerV490Guard(); initComposerOptInOnly(); initComposerInlineReturn(); initHorizontalRailButtons(); initReelExperience(); initVideoCovers(); /* v4.2.262: mini video disabled here, owned by community.js */ }
 ...
 * on pages where Reel buttons exist but feed viewer markup is absent.
 */
(function () {
  'use strict';
  var doc = document;
...
(function () {
  ...
  function scrollToLatest() {
    ...
    if (!card) {
      feed = doc.getElementById('tb4cFeedList') || doc.querySelector('.tb4c-feed-list');
      card = feed ? feed.querySelector('.tb4c-post-card,[data-post-id]') : null;
    }
    if (!card) return;
...
(function () {
  ...
  function patchSmoothScrollForSlowDevices() {
    ...
    proto.scrollIntoView = function (arg) {
      var scoped = this && this.closest && this.closest('.tb4c-shell, #tb4c-community-app, .tb4c-modal, .tb4c-reel-viewer, .tb4-home-feed-main');
